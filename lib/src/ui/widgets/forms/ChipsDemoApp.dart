...
class ChipsDemoScreen extends StatefulWidget {
  ...
  ////////////////{ https://www.appwithflutter.com/flutter-chip-example-flutter-widget/ } ////////////////

  @override
  _ChipsDemoScreenState createState() => _ChipsDemoScreenState();
}
...
class ChipsInputState<T> extends State<ChipsInput<T>> implements TextInputClient {
  ...
  void _onSearchChanged(String value) async {
    ...
    if (_searchId == localId && mounted) {
      setState(() => _suggestions = results.where((profile) => !_chips.contains(profile)).cast<T>().toList(growable: false));
    }
  }
